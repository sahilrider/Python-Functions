...
* Scikit-Learn ML
   ...
   * [K nearest neighbors (KNN) to predict the stock market based on S&P500 dataset](https://github.com/sahilrider/Python-Codes/blob/master/LinearRegression/linear.Py)
